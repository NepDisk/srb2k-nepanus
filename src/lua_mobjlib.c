...
static const udata_field_t mobj_fields[] = {
    ...
    FIELD(mobj_t, haveshadow,           udatalib_getter_boolean,    udatalib_setter_boolean),
    FIELD(mobj_t, shadowscale,         udatalib_getter_fixed,      udatalib_setter_fixed),
    FIELD(mobj_t, whiteshadow,           udatalib_getter_boolean,    udatalib_setter_boolean),
