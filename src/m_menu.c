...
static menuitem_t OP_ControlsMenu[] =
{
	...
	{IT_STRING | IT_CVAR, NULL, "Strafe in Spectate", &cv_spectatestrafe,  70},
	
	

	{IT_STRING | IT_CVAR, NULL, "Controls per key",    &cv_controlperkey, 90},
	{IT_STRING | IT_CVAR, NULL, "Digital turn easing", &cv_turnsmooth, 100},
};
...
static menuitem_t OP_GameOptionsMenu[] =
{
	...
	{IT_SUBMENU|IT_STRING,		NULL, "Neptune Gameplay Options...",	&OP_NeptuneDef,		 20},
...
static menuitem_t OP_SaturnMenu[] =
{
	...
	{IT_SUBMENU|IT_STRING, NULL, "Neptune Options...", 					&OP_NeptuneTwoDef, 	10},
...
static const char* OP_NeptuneTooltips[] =
{
	...
	"Should panels be seperate from sneakers?",
...
void M_Drawer(void)
{
	...
	if (menuactive)
	{
		...
		if (currentMenu == &MainDef)
		{
			...
			{
				V_DrawThinString(vid.dupx, vid.height - 30*vid.dupy, V_NOSCALESTART|V_TRANSLUCENT, "Mod version:");
			...
			else
			{
				...
				V_DrawThinString(vid.dupx, vid.height - 30*vid.dupy, V_NOSCALESTART|V_TRANSLUCENT|V_ALLOWLOWERCASE, compbranch);
